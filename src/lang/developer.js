...
const firmware = {
  ...
  2: 'https://www.ufactory.cc/developer/swift/SwiftProForArduino-Version_V4.0_20181022.zip',
    ...
    document: {
     ...
     3:{
      ...
      7:{
        title: "uArm-固件指引",
        content: "",
        link: "http://download.ufactory.cc/docs/cn/uArm-%E5%9B%BA%E4%BB%B6%E6%8C%87%E5%BC%95.pdf",
        icon: images[1],
      },
      2:{
      ...
      4:{
        title: "uArm ROS",
        content: "支持Moveit!, RViz 以及串口通信。<br>适用于uArm Swift Pro及uArm Swift.",
  ...
  en: {
    document: {
      ...
      7:{
        ...
        content: "",
        link: "http://download.ufactory.cc/docs/en/uArm-Firmware%20Guidance.pdf",
        icon: images[1],
      },
      2:{
      ...
      4:{
        title: "uArm ROS",
        content: "uArm ROS packages support Moveit!, RViz and serial communication.<br>Support uArm Swift Pro and uArm Swift.",
        link: "http://download.ufactory.cc/developer/swift/RosForSwiftAndSwiftPro-master_20180620.zip",
        icon: images[3],
      },
      6:{
