...
const langText = {
  cn:{
    submenu:{
      ...
      question:"常见问题",
      download:"软件下载",
      storeLink: setting.STORE_URL_XARM,
      buyText:"立即购买",
      teachVideo: "教学视频",
    },
    banner1:{
...
//				videoLink:"https://www.youtube.com/embed/kzEkjx6Lmfg?rel=0&amp;autoplay=1",
    ...
    banner2:{
      title:"Arm——高效生产力工具",
      content: `xArm是一款轻量级可编程工业机器人，高效部署，简单易用，能帮助您提高生产效率。`,
      paramsList: [
        { name:'有效工作半径', value: '691 mm'},
    ...
    banner5:{
      imageList: [
        {
          title: 'xArm 7',
          content: 'xArm 7 拥有7个自由度，灵巧如热手，除了完成常规机器人应用外，xArm7 还能完美适用于服务业、AI研究以及影像行业等。',
    ...
    banner9:{
      title: "X86 平台",
      content: `xArm使用性能强劲ARM X86芯片，X86通用架构让二次开发如虎添翼。`,
    },
    banner10:{
    ...
    xarmParams: {
      ...
      xarms: [
        [`<span style="font-size: 14px;font-weight: 700;padding-bottom:10px;">xArm 5 Lite*</span>`, "2kg", "691mm", "5", "±0.2", "0.33", "8.5"],
        [`<span style="font-size: 14px;font-weight: 700;padding-bottom:10px;">xArm 6</span>`, "5kg", "691mm", "6", "±0.1", "1", "9.5"],
        [`<span style="font-size: 14px;font-weight: 700;padding-bottom:10px;">xArm 7</span>`, "3.5kg", "691mm", "7","±0.1", "1","11"]
      ]
    },
  },
  en:{
    ...
    banner1:{
      ...
      // video: require("../components/assets/img/xarm/xarm_section1.mp4"),
      title:'xArm',
      content:'The Most Cost-Effective Industrial Robotic Arm',
...
//				videoLink:"https://www.youtube.com/embed/kzEkjx6Lmfg?rel=0&amp;autoplay=1",
    ...
    banner9:{
      ...
      content: `xArm is powered by ARM X86 chip which is powerful enough to handle the complex controlling algorithm. With an optimized the control algorithm, guaranteeing
