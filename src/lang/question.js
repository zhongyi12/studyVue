...
//				},
    ...
    2:{
      1:{
        qtext:"售后服务流程",
        atext:"请提交客户反馈表单反馈您的问题，我们会在5个工作日内与您联系，如有需要我们会与您多次沟通定位和解决您的问题。"
      },
      2:{
        qtext:"售后维修流程",
        atext:"售后人员已经与您协商确定将产品寄回厂家维修（未经协商寄回的机械臂我们将拒收）； 在收到您的产品之后，售后技术部门会进行返修产品检测，评估维修费用；售后人员反馈检测到的问题，给您发送当次维修的费用清单，在收到维修清单后，请您将维修款项汇入至指定银行账户，如有异议请在2个工作日内提出。产品完成维修后，售后人员再次与您确认收货地址等信息，维修款项默认不开发票，如需发票请说明。"
      },
      3:{
        qtext:"免费维修和付费维修",
        atext:"我们提供7天内免费换货服务（UFACTORY承担来回运费），三个月内包修服务（UFACTORY承担更换零件费用、维修工时费用、来回运费），一年内保修服务（UFACTORY承担维修工时费用、来回运费，用户承担零件更换费用），付费维修服务（购买产品超过一年，UFACTORY不承担以上任何费用）。"
      }
    },
    3:{
      1:{
    ...
    4:{
      ...
      2:{
        ...
        atext:["请参考以下链接：<a class='linktext' href='https://grabcad.com/library/uarm-metal-1' target='_blank'>https://grabcad.com/library/uarm-metal-1</a>"]
      },
      4:{
        qtext:"如何校正机械臂？",
        atext:["打开uArm助手，选择对应端口，点击重新校正。（2016年4月份之后购买机械臂的用户严禁自行校正，否则可能产生严重后果。）"]
      },
      6:{
        qtext:"蓝牙连接模式下无法将framware刷入机械臂",
        atext:["蓝牙连接模式下，PC与机械臂只可以实时数据传输，PC端无法将framware固件刷入机械臂，如需要刷固件，请使用USB连接线；注：蓝牙连接下手机无法通过蓝牙控制机械臂，官方目前不支持移动端软件控制机械臂。"]
      },
      7:{
        qtext:"机械臂是2016年以前购买的，应不应该刷入最新的framware固件？",
        atext:["由于最新的固件和16年之前的校正程序有不兼容的部分，用户在刷入最新固件后可能会导致不能正常控制机械臂的情况，请参考（第4点：用户自行校正机械臂的教程）自行完成机械臂的校正，完成之后即可正常使用。"]
      }
    },
    5:{
      1:{
        qtext:"投资咨询",
        atext:`投资者咨询请点击下方“更多问题”填写表单</a>，我们会在提交后5个工作日内回复，谢谢。`
      },
      2:{
        qtext:"代理经销商咨询",
        atext:`代理和经销商咨询请点击下方“更多问题”填写表单</a>，我们会在提交后5个工作日内回复，谢谢。`
      },
    },
    'pro':{
      1:{
      ...
      7:{
        qtext:"怎么购买额外的配件？",
        atext:`购买额外配件请联系info@ufactory.cc`,
      }
    },
    'swift':{
      1:{
...
//            'The policies are valid for products purchased after Oct 16th, 2017',
    ...
    2:{
      1:{
        qtext:"How can I reach the after-sales team?",
        atext:`Please submit your questions in customer service system`
      },
      2:{
        qtext:"Can I get my product repaired or replaced?",
        atext:"If your uArm is damaged, we will examine the problematic part of your uArm and deliver the relative accessory to you. And you can replace the damaged accessory. "
      }
    },
    3:{
      1:{
    ...
    4:{
      ...
      2:{
        ...
        atext:["<a target='_blank' class='linktext' href='https://grabcad.com/library/uarm-metal-1'>https://grabcad.com/library/uarm-metal-1</a>"]
      },
      3:{
        qtext:"How to use the uArm Metal Bluetooth module?",
        atext:["Please ensure that the firmware is upgraded to the latest version. Please connect Bluetooth module to the correct port of uArm board (according to the board specifications above 5th). While connected, the bluetooth module will flicker with blue lights. Please connect another Bluetooth module to your PC. If the two Bluetooth modules match successfully，the blue light is always on. Now you can start uClient to connect the uArm. Currently, the uArm Metal cannot be controlled via mobile phone with Bluetooth module. "]
      },
      5:{
    ...
    5:{
      1:{
        qtext:"investment advisory",
        atext:`Investors Advisory please click the "Ask Questions" button on the buttom of this page to report your problem., fill in the form and submitted, we will reply within 5 working days, thank you.`
      },
      2:{
        qtext:"agent/dealer Advisory",
        atext:`Investors Advisory please click the "Ask Questions" button on the buttom of this page to report your problem., fill in the form and submitted, we will reply within 5 working days, thank you.`
      },
    },
    'pro':{
      ...
      7:{
        ...
        atext:`Please write to info@ufactory.cc to order extra accessories`,
      }
    },
    'swift':{
      1:{
