        ...
        <div class="panel-body software">
          ...
          <div v-for="(item, index) in remoteData.software"  class="software-wrapper">
            ...
            <div v-for="(soft, index2) in item[showProduce]" class="wrapper-block">
              ...
              <span class="system-name"> {{ index }}</span>
          ...
          <div class="wrapper-block">
            ...
            <div style="display: flex;">
              <div class="mobile-ipad">
                <div class="">
                  <div class="mobile-notes">{{ mobileApp.qrcode_ios[language] }} v1.0.6</div>
                ...
                <a href="http://download.ufactory.cc/mobile/PLAY-uArmController.apk" class="item-wrap" target="_blank">
                  <div class="ghost-button"><i class="fa fa-android fa-lg" aria-hidden="true"></i><span>{{langData.download}}</span></div>
                </a>
                <a href="https://itunes.apple.com/us/app/play-uarm-controller/id1235531885?mt=8" class="item-wrap" target="_blank">
                  <div class="ghost-button"><i class="fa fa fa-apple fa-lg" aria-hidden="true"></i><span>{{langData.download}}</span></div>
                </a>
              </div>
              <div class="mobile-ipad">
                <div class="">
                  <div class="mobile-notes">{{ mobileApp.qrcode_ipad[language] }} v1.0.2</div>
                ...
                <a href="https://itunes.apple.com/us/app/draw-make-uarm-draw-engrave/id1247770902?l=zh&ls=1&mt=8" class="item-wrap" target="_blank">
                  <div class="ghost-button"><i class="fa fa fa-apple fa-lg" aria-hidden="true"></i><span>{{langData.download}}</span></div>
                </a>
              </div>
            </div>
