    ...
    <div class="footer-page-wrap">
      <div class="footer-content">
          ...
          <div class="bottom-menu">
            ...
            <table>
              ...
              <tr>
                ...
                <td><router-link :to="{name:'developer',params:{lang:country}}">{{langData.navDeveloper}}</router-link></td>
                <td><router-link :to="{name:'about',params:{lang:country,position:'about'}}">{{langData.navAboutUf}}</router-link></td>
              </tr>
              <tr>
                <td><router-link :to="{name:'xarm',params:{lang:country}}">xArm</router-link></td>
        ...
        <div class="social-language">
          ...
          <div class="copyright">
            &copy;&nbsp;2018 UFACTORY All Rights Reserved&nbsp;{{langData.copyright}}
          </div>
        </div>
        </div>
      </div>
