    ...
    <div class="page-wrapper">
        <div class="question-wrap">
          ...
          <div class="cooperation-wrap" v-show="showData =='policy'" id="policy">
            ...
            <el-collapse>
              <el-collapse-item v-for="(item, index) in langData.aftersales" :title="item.title" :name="item.name" :key="index">
                <div v-for="(value, valueIndex) in item.content" :key="valueIndex">
                  <div v-for="(html, htmlIndex) in value.html" :key="htmlIndex" v-html="html"></div>
                  <ul class="collapse-list">
                    <li v-for="(list, listIndex) in value.list" :key="listIndex" v-html="list"></li>
                  </ul>
                </div>
              </el-collapse-item>
            </el-collapse>
